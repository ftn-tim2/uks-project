...
urlpatterns = patterns('',
                       ...
                       url(r'^issuetype_update/(?P<project_id>\d+)/(?P<issuetype_id>\d+)/$', views.issuetype_update,
                           name='issuetype_edit'),
                       url(r'^issuetype_delete/(?P<project_id>\d+)/(?P<issuetype_id>\d+)/$', views.issuetype_delete,
                           name='issuetype_delete'),

                       url(r'^priority_create/(?P<project_id>\d+)$', views.priority_create, name='priority_new'),
                       url(r'^priority_update/(?P<project_id>\d+)/(?P<priority_id>\d+)/$', views.priority_update,
                           name='priority_edit'),
                       url(r'^priority_delete/(?P<project_id>\d+)/(?P<priority_id>\d+)/$', views.priority_delete,
                           name='priority_delete'),

                       url(r'^status_create/(?P<project_id>\d+)$', views.status_create, name='status_new'),
                       url(r'^status_update/(?P<project_id>\d+)/(?P<status_id>\d+)/$', views.status_update,
                           name='status_edit'),
                       url(r'^status_delete/(?P<project_id>\d+)/(?P<status_id>\d+)/$', views.status_delete,
                           name='status_delete'),

                       url(r'^milestone_create/(?P<project_id>\d+)$', views.milestone_create, name='milestone_new'),
                       url(r'^milestone_update/(?P<project_id>\d+)/(?P<milestone_id>\d+)/$', views.milestone_update,
                           name='milestone_edit'),
                       url(r'^milestone_delete/(?P<project_id>\d+)/(?P<milestone_id>\d+)/$', views.milestone_delete,
                           name='milestone_delete'),

                       url(r'^issue_list$', views.issue_list, name='issue_list'),
                       url(r'^issue_create/(?P<project_id>\d+)/$', views.issue_create,name='issue_new'),
                       url(r'^issue_create/(?P<project_id>\d+)/(?P<commit_id>[^/]+)/$', views.issue_create_with_commit_hash,name='issue_new'),
